        ...
        if ($form->isSubmitted() && $form->isValid()) {
            switch ($request->get('mode')) {
                ...
                case 'complete':
                    ...
                    // firebase_uid,line_uid,yahoo_uidについてもemailと同様の処理。
                    $Customer->setFirebaseUserId(StringUtil::random(60).'@firebase');
                    $Customer->setLineUserId(StringUtil::random(60).'@line');
                    $Customer->setYahooUserId(StringUtil::random(60).'@yahoo');
